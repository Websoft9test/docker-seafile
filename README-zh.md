...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Seafile 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://cloud.seafile.com/published/seafile-manual-cn/docker/)）：
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| seafile | 9100 | 浏览器访问Seafile | Y |
| onlyoffice-document-server | 9002 | 浏览器访问ONLYOFFICE Document | N |
| mariadb | 3306 | TCP 访问MariaDB数据库 | Y |
## 文档

[Seafile 管理员手册](https://support.websoft9.com/docs/seafile)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Seafile 企业级支持版](https://apps.websoft9.com/seafile) 
